    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Tones uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c057e2df-10a2-485c-9681-28290de409a3',
                    name: data.name || '',
                    email: data.email || '',
